...
class ContentSeeder extends Seeder
{
    ...
    private function seedSettings(): void
    {
        $settings = [
            ...
            'email'          => 'thierry.sudol@fab-sourcing.fr',
