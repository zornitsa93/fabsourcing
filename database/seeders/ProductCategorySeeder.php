    ...
    public function run(): void
    {
        ...
        $categories = [
            ...
            [
                ...
                'desc_fr'       => 'Revêtements architecturaux en acier, aluminium, zinc ou inox, finitions au choix (poudré, anodisé, naturel).',
                'desc_en'       => 'Architectural cladding in steel, aluminium, zinc or stainless steel, choice of finishes (powder-coated, anodised, natural).',
            ],
            [
