...
@section('description', $lang === 'fr'
    ? "Sourcing industriel, sous-traitance, industrialisation, gestion logistique et contrôle qualité — Fab Sourcing coordonne votre production en Bulgarie."
    : 'Industrial sourcing, subcontracting, industrialization, logistics management and quality control — Fab Sourcing coordinates your production in Bulgaria.')
        ...
        <div>
          ...
          <p class="lede" style="margin-top:24px">
            {{ $page->getTranslation('hero_lede', $lang, false)
              ?: ($lang === 'fr'
                ? "De la pièce unitaire à la grande série, Fab Sourcing coordonne l'ensemble de la chaîne de fabrication depuis un réseau d'usines partenaires en Bulgarie."
                : 'From unit production to large series, Fab Sourcing coordinates the entire manufacturing chain through a network of partner workshops in Bulgaria.') }}
          </p>
        </div>
        <div>
          <img
  ...
  <div class="container">
    ...
    <div class="section-intro reveal" style="margin-bottom:48px">
      ...
      <h2 class="h-2" style="margin-top:16px">
        @if($lang === 'fr')
          Une offre complète :<br><em>de l'étude à la livraison</em>
        @else
          A complete offer:<br><em>from study to delivery</em>
        @endif
      </h2>
      <p class="lede" style="margin-top:16px">
        {{ $lang === 'fr'
          ? "Nous proposons une solution clé en main pour l'externalisation de vos projets industriels :"
          : 'We offer a turnkey solution for outsourcing your industrial projects:' }}
      </p>
    </div>
    ...
    <p class="lede reveal" style="margin-top:40px; max-width:780px">
      👉 {{ $lang === 'fr'
        ? "L'outsourcing permet aux entreprises de se concentrer sur leur cœur de métier tout en améliorant leur efficacité opérationnelle"
        : 'Outsourcing allows companies to focus on their core business while improving operational efficiency' }}
      <a href="https://expertallies.com/industry-insights-why-companies-outsource-to-eastern-europe/" target="_blank" rel="noopener">(expertallies.com)</a>
    </p>
