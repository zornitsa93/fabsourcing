...
@section('description', $lang === 'fr'
    ? 'Notre processus en 8 étapes : analyse du besoin, étude technique, sélection fournisseur, prototype, production, rapport d\'avancement, contrôle qualité, livraison.'
    : 'Our 8-step process: needs analysis, technical study, supplier selection, prototype, production, progress report, quality control, delivery.')
...
<x-seo
  ...
  :description="$lang === 'fr'
    ? 'Découvrez notre processus en 8 étapes pour une externalisation industrielle réussie en Bulgarie. De l\'analyse au suivi qualité.'
    : 'Discover our 8-step process for successful industrial outsourcing in Bulgaria. From analysis to quality monitoring.'"
  ...
  <div class="container">
    <div class="page-hero-grid reveal">
      <div>
        ...
        <h1 class="h-1">
          @if($lang === 'fr')
            Notre <em>méthode</em> en 8 étapes
          @else
            Our <em>method</em> in 8 steps
          @endif
        </h1>
      </div>
      <div>
...
<section class="section">
  <div class="container">
    ...
    $stepIcons = [
      ...
      '06' => '<path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>',
      '07' => '<path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>',
      '08' => '<path d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0zM13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414A1 1 0 0121 11.414V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0"/>',
    ];
    @endphp
