...
@section('welcome')
    <h1 class="title has-text-centered is-family-primary">{{ __('Добавяне на Администратор') }}</h1>
@endsection
    ...
    <section class="section pl-0 pr-0 pt-2">
        <form action="{{ route('admins.store') }}" method="POST">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input  @error('email') is-danger @enderror" type="email" name="email" required  value="{{ old('email') }}">
                </div>
                @error('email')
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input  @error('password') is-danger @enderror" type="password" required name="password" value="">
                </div>
                @error('password')
